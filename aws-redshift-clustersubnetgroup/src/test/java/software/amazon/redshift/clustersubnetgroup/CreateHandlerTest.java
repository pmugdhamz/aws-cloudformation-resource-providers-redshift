...
import static software.amazon.redshift.clustersubnetgroup.TestUtils.DESCRIPTION;
...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        Map<String, String> allTags = new HashMap<>(DESIRED_RESOURCE_TAGS);
        allTags.put("aws:cloudformation:stack-name", "testStack");

        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(MODEL_WITH_TAGS)
                .region(AWS_REGION)
                .desiredResourceTags(allTags)
